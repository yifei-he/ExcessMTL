...
def parse_args(parser):
    ...
    parser.add_argument('--flip', default=0, type=float, help='flip rate for noise insertion')
    parser.add_argument('--flipped_task', default=None, type=str, help='flipped task')
...
def main(params):
    ...
    # prepare dataloaders
    data_loader, _ = office_dataloader(dataset=params.dataset, batchsize=params.bs, root_path=params.dataset_path, flip=params.flip, flipped_task=params.flipped_task)
